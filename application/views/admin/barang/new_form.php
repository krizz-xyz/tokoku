		...
		<div class="card-body">
			...
			--->
				<div class="form-group">
					<label for="name">Kodebrg*</label>
					<input class="form-control <?php echo form_error('kodebrg') ? 'is-invalid':'' ?>"
					 type="text" name="kodebrg" placeholder="Kode barang" />
				...
				<div class="form-group">
					...
					<input class="form-control <?php echo form_error('hargajual') ? 'is-invalid':'' ?>"
					 type="number" name="hargajual" min="0" placeholder="Harga jual" />
					<div class="invalid-feedback">
